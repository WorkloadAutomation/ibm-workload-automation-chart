...
*/}}
{{- define "aida-ui.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
{{/*
Common labels
*/}}
{{- define "aida-ui.labels" -}}
helm.sh/chart: {{ include "aida-ui.chart" . }}
{{ include "aida-ui.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "aida-ui.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aida-ui.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
{{/*
Create the name of the service account to use
*/}}
{{- define "aida-ui.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "aida-ui.fullname" .) .Values.serviceAccount.name }}
{{- else }}
