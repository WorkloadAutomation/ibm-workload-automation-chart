...
*/}}
{{- define "aida-ad.chart" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
{{/*
Common labels
*/}}
{{- define "aida-ad.labels" -}}
helm.sh/chart: {{ include "aida-ad.chart" . }}
{{ include "aida-ad.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "aida-ad.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aida-ad.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
{{/*
Create the name of the service account to use
*/}}
{{- define "aida-ad.serviceAccountName" -}}
